...
export default function Page() {
  ...
  const compras = cartao.compras.filter((c) => c.descricao.toLowerCase().includes(busca.toLowerCase()));
    ...
    <main className="pageRoot">
      <style jsx global>{`
        * { box-sizing: border-box; }
        ...
        .pageRoot { min-height: 100vh; padding: 12px; }
        ...
        .iconAction {
          ...
          background: rgba(111, 104, 255, 0.14);
          color: #fff;
          font-size: 18px;
          font-weight: 700;
          display: inline-flex;
        ...
        .select {
          ...
          background: #020a29;
          color: #fff;
          border: 1px solid rgba(119,140,248,.18);
          border-radius: 16px;
          padding: 14px 14px;
          font-size: 15px;
          outline: none;
        ...
        .heroInvoice { margin-top: 14px; }
        .invoiceLabel { font-size: 12px; color: rgba(213, 221, 255, 0.68); margin-bottom: 4px; }
        .invoiceValue { font-size: 22px; font-weight: 800; line-height: 1.1; }
        ...
        .statLabel { font-size: 11px; color: rgba(213, 221, 255, 0.68); margin-bottom: 6px; }
        .statValue { font-size: 18px; font-weight: 800; line-height: 1.1; word-break: break-word; }
        .input {
          width: 100%;
          background: #020a29;
          color: #fff;
        ...
        .purchaseList { display: grid; gap: 10px; margin-top: 12px; }
        .purchaseCard {
          background: rgba(7, 12, 34, 0.82);
        ...
        .purchaseTitle { font-size: 15px; font-weight: 700; margin-bottom: 4px; }
        .purchaseSub { font-size: 12px; color: rgba(213, 221, 255, 0.68); line-height: 1.4; }
        .purchaseBottom {
          display: flex;
          justify-content: space-between;
          align-items: center;
        ...
        .purchaseValue { font-size: 16px; font-weight: 800; }
        .miniBtn {
      ...
      <div className="container">
        <div className="topBar">Cartão secreto</div>
        ...
        <section className="card">
          ...
          <input className="input" placeholder="Buscar compra" value={busca} onChange={(e) => setBusca(e.target.value)} />

          <div className="purchaseList">
            {compras.map((compra) => <CompraItem key={compra.id} compra={compra} />)}
          </div>
        </section>
